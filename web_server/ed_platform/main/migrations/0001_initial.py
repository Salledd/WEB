# Generated by Django 5.1.3 on 2024-12-21 16:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('OE', 'Open-ended'), ('MC', 'Multiple-choice')], max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='Users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(limit_choices_to={'role': 'T'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='teacher', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Grades',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField()),
                ('material', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='main.materials')),
            ],
        ),
        migrations.CreateModel(
            name='Messages',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completed_materials', models.ManyToManyField(blank=True, to='main.materials')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.courses')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tests', to='main.courses')),
